...
const hometwo= () => (
  <div>
    <GlobalStyles />
      <section className="jumbotron no-bg h-vh" style={{background: `rgba(0, 0, 0, 0)url(${'./img/background/17.jpg'})repeat scroll center bottom / cover`}}>
         <SliderMainZero/>
      </section>
    ...
    <div className="row">
        ...
        <div className="bloglist item">
            <div className="post-content">
                <div className="post-image">
                    <img alt="" src="./img/news/news-a1.jpg" className="lazy"/>
                </div>
      ...
      <div className="col-lg-4 col-md-6 mb30">
        <div className="bloglist item">
            <div className="post-content">
                <div className="post-image">
                    <img alt="" src="./img/news/news-a2.jpg" className="lazy"/>
                </div>
                <div className="post-text">
                    <span className="p-tagline">Tips &amp; Tricks</span>
                    <span className="p-date">October 28, 2020</span>
      ...
      <div className="col-lg-4 col-md-6 mb30">
        <div className="bloglist item">
            <div className="post-content">
                <div className="post-image">
                    <img alt="" src="./img/news/news-a3.jpg" className="lazy"/>
                </div>
                <div className="post-text">
                    <span className="p-tagline">Tips &amp; Tricks</span>
                    <span className="p-date">October 28, 2020</span>
