...
import mp1 from '../../assets/mp3.png'
 ...
 <div className="container">
    <div className="row align-items-center">
          <div className="col-md-6">
              ...
              One way for a wildlife conservation.Anyone can mint and send NFTs using our platform,the generated funds will be used to protect the endangered species.
              </p>
              </Reveal>
...
export default slidermainparticle3;